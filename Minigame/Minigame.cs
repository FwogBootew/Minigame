...
namespace Oxide.Plugins
{
    ...
    public class Minigame : RustPlugin
    {
        ...
        public class SurvivalGame : Game
        {
            ...
            private Vector3 grillPos;
            private Vector3 door1Pos;
            private Vector3 door2Pos;

            private int waveCount;

            private List<BasePlayer> alivePlayers;
            public SurvivalGame(Vector3 hubPos, Vector3 startPos, Vector3[] zombiePos, Vector3 grillPos, Vector3 door1Pos, Vector3 door2Pos)
            {
                GameName = "Survival";
                players = new List<BasePlayer>();
                playerMax = 8;
            ...
            public override void OnPlayerDie(BasePlayer player)
            {
                foreach(var person in alivePlayers)
                {
                    if (person == player) alivePlayers.Remove(person);
                }
            }
            public override BasePlayer.SpawnPoint getPlayerSpawn()
            {
